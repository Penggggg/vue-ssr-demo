...
var OtherCtrl = /** @class */ (function () {
    ...
    OtherCtrl.prototype.swiperPic = function () {
    ...
    __decorate([
        routing_controllers_1.Get('/swiper-pic'),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Promise)
    ], OtherCtrl.prototype, "swiperPic", null);
    OtherCtrl = __decorate([
        routing_controllers_1.Controller('/api/other'),
        inversify_1.injectable()
    ], OtherCtrl);
    return OtherCtrl;
}());
exports.OtherCtrl = OtherCtrl;
